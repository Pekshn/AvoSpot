...
let recipesData: [Recipe] = [
    ...
    Recipe(title: "Avocado Bacon Toast", headline: "The best toastie you'll ever make.",
           image: "avocado-toast-bacon", rating: 5, serves: 2, preparation: 5, cooking: 5, instructions: [
    ...
    Recipe(title: "Avo Hollandaise Toast", headline: "Avocado twist on a classic toast.",
           image: "avocado-toast-hollandaise", rating: 4, serves: 4, preparation: 15, cooking: 25, instructions: [
    ...
    Recipe(title: "Avocado Bacon Pizza", headline: "You can have pizza with avocado.",
           image: "avocado-pizza-bacon", rating: 5, serves: 1, preparation: 5, cooking: 14, instructions: [
    ...
    Recipe(title: "Avocado Eggs Salad", headline: "Give your average egg salad a mix-up.",
           image: "avocado-salad-egg", rating: 4, serves: 2, preparation: 10, cooking: 0, instructions: [
    ...
    Recipe(title: "Avo Turkey Sandwich", headline: "Add grilled cheese for a flavour sensation.",
           image: "avocado-sandwich-turkey", rating: 4, serves: 1, preparation: 10, cooking: 0, instructions: [
    ...
    Recipe(title: "Avocado Salsa", headline: "A salsa with a bit of crunch and celery.",
           image: "avocado-crunchy-celery-salsa", rating: 5, serves: 1, preparation: 10, cooking: 5, instructions: [
    ...
    Recipe(title: "Avocado Guacamole", headline: "An option for every tastebud.",
           image: "avocado-guacamole-trio", rating: 4, serves: 1, preparation: 10, cooking: 0, instructions: [
    ...
    Recipe(title: "Avo Smoothie Bowl", headline: "Blend & enjoy avocado.",
           image: "avocado-smoothie-bowl", rating: 5, serves: 1, preparation: 15, cooking: 10, instructions: [
